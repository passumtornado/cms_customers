<?php
session_start();
if(!isset($_SESSION['username'])&&!!isset($_SESSION['cID'])){
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a class="active" href="product.php?source=menu" id="login"><span class="glyphicon glyphicon-modal-window"></span>products</a>
                    </li>
                    <li class="dropdown">
                        <a href="index.php?source=signup" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <?php echo " <span style='font-size:12; text-transform: lowercase ! important;'>Hi {$_SESSION['username']} </span>
                         ...
                         <ul class="dropdown-menu">
                             <li><a href="checkout_order.php"><span class="glyphicon glyphicon-shopping-cart"></span>MyCart</a></li>
