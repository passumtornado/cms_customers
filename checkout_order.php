                    ...
                    <li class="dropdown">
                        <a href="index.php?source=signup" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <?php echo " <span style='font-size:12; text-transform: lowercase ! important;'>Hi {$_SESSION['customer']} </span>
                         ...
                         <ul class="dropdown-menu">
                             <li><a href="#" id="cart_container"><span class="glyphicon glyphicon-shopping-cart"></span>MyCart</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                      ...
                      <div class="panel panel-primary">
                          <div class="panel-heading">Food checkOut</div> 
                         ...
                         <div class="row">
                             <div class="col-md-3"></div>
                              <div class="col-md-6 col-xs-6">
                                 <div class="btn-group" >
                                     <div class="row">
                                     <div class="col-md-3"><a href="view_cart.php"><button class="btn btn-primary btn-lg">breakfast</button> </a> </div>
                                         <p><br/></p>
                                    <div class="col-md-3"><a href="#"><button class="btn btn-danger btn-lg">Lunch</button> </a></div>
                                         <p><br/></p>
                                    <div class="col-md-3"><a href="#"><button class="btn btn-success btn-lg">supper</button> </a> </div>
                                         <p><br/></p>
                                    <div class="col-md-3"> <a href="#"><button class="btn btn-warning btn-lg">Combo</button> </a> </div>
                                     </div>
