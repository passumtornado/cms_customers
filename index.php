        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li >
                        <a class="active" href="index.php" ><span class="glyphicon glyphicon-home"></span>Home</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="index.php?source=login" id="login"><span class="glyphicon glyphicon-off"></span>Login</a>
                    </li>
                    <li>
                        <a href="index.php?source=signup"><span class="glyphicon glyphicon-"></span>SignUp</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
